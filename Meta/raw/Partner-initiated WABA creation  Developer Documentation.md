---
title: "Partner-initiated WABA creation | Developer Documentation"
...
7. Instruct the customer to accept the request. See [Business customer instructions](#business-customer-instructions) below for content you can send them.

## Onboarding business customers

1. Listen for an **account\_update** webhook with the `event` property set to `PARTNER_ADDED` or `PARTNER_APP_INSTALLED`, or look for a developer notification or developer alert, indicating that the customer has accepted your request.
