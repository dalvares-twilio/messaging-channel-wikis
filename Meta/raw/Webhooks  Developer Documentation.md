...
To receive webhooks, you must create and configure a webhook endpoint. To create your own endpoint, see our [Create a webhook endpoint](https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/create-webhook-endpoint) document
...
- **whatsapp\_business\_messaging** — for **messages** webhooks
- **whatsapp\_business\_management** — for all other webhooks
...
See our [Webhook overrides](https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/override) document to learn how to override webhooks.
...
Note, however, that we periodically change our IP addresses, so to avoid having to regenerate your list of allowed IP addresses, we recommend that you [use mTLS instead](https://developers.facebook.com/docs/graph-api/webhooks/getting-started#mtls-for-webhooks).
...
- Use our [test webhook endpoint](https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/set-up-whatsapp-echo-bot). If the test endpoint is digesting webhook payloads and displaying them in the console, the issue is likely with your endpoint code.

## Learn more

- See our [Using Node.js to implement webhooks⁠](https://l.facebook.com/l.php?u=https%3A%2F%2Fbusiness.whatsapp.com%2Fblog%2Fhow-to-use-webhooks-from-whatsapp-business-api%3Ffbclid%3DIwZXh0bgNhZW0CMTAAYnJpZBExdzk4aWdSbU1aMnRFck9GbHNydGMGYXBwX2lkEDIyMjAzOTE3ODgyMDA4OTIAAR7_qYHBfSoUn7WHJI1ErzPg_LolPp4xn3o2ATqDFbzDyssJOKYiP7Yk6_bFVw_aem_72WV4ttqi-kvWDDR2YthZw&h=AT4R8NzvfEcbGOdwEmA6Rb1qoUbbmT3_G25f9rz70CNcAhS7p3_cTiSqQQ8INrOm2oELw_UsS8qtsLO6gZKEHe7h1hhUvrGbT2LzuzM53_x4RmnI4RSjF8p3a6QGGgZJjss1s-CPgm4) WhatsApp Business blog post.
